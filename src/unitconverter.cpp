...
void UnitConverter::initializeDSMCUnits() {
    UnitConverter::initialized = true;
    UnitConverter::currentUnits = "DSMC units";
...
void UnitConverter::makeSureInitialized() {
    if(!UnitConverter::initialized) UnitConverter::initialize(Units::DSMC);
}

void UnitConverter::initialize(Units type) {
    if(type == Units::DSMC) UnitConverter::initializeDSMCUnits();
}
